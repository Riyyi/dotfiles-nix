    ...
    in
    {
      ...
      programs.firefox = {
        ...
        profiles.${profile} = {
          ...
          userChrome = builtins.readFile ./../../modules/home-manager/dotfiles/.mozilla/firefox/userChrome.css;
          #userContent = builtins.readFile ./../../modules/home-manager/dotfiles/.mozilla/firefox/userContent.css; # FIXME: this is broken
